...
exec stpAddTemplatePrimaryEx @AppID, 'URL1', '', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'URL2', '', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'UUI Template', 'vdnflag;idNum,9;fileNum;custType;vdn;zihui;tashlum;hov;ani;lang', 'ITNVCRMPopup', '',1,1,1,0
...
exec stpAddTemplatePrimaryEx @AppID, 'OutboundCampaignPopupExe', 'PopPhone.exe', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'OutboundCampaignFlagFromUUI', 'vdnflag', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'OutboundCampaignFlagValue', '100', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'OupboundCampaignParams', '<projpivotal> <camppivotal> <ucid> <ani>', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'OupboundCampaign UUI Template', 'vdnflag;idNum;ani;ucid;camppivotal;projpivotal', 'ITNVCRMPopup', '',1,1,1,0
...
exec stpAddTemplatePrimaryEx @AppID, 'URL0', 'http://172.16.5.207/WSExample/WSExample.asmx', 'ITNVCRMPopup', '',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'PopupType', '3', 'ITNVCRMPopup', '1- new ie, 2 - new tab in ie; 3 - in the same tab',1,1,1,0
exec stpAddTemplatePrimaryEx @AppID, 'URL', 'http://abtil1z1200:5555/ACC/WebResources/new_crmandavayapageconnector?data=<ANI>,<UCID>', 'ITNVCRMPopup', '',1,1,1,0
